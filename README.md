<div align="center">
  ...
  A free UCI chess engine, written in Python.

</div>

## Overview

[PyFish][website-link] is a **free UCI chess engine** largely derived from,
although millions of times weaker than, [Stockfish][sf-link].
It analyzes chess positions and computes the somewhat optimal moves.
