...
# none as of now
def on_hash_change(value):
    """Called when the hash size is changed."""
    # TODO
    pass
...
options = {
    ...
    # "Threads": Option.Spin("Threads", 1, 1, 1024),  # Threads not supported
    "Hash": Option.Spin("Hash", 256, 1, 1 << 25, func=on_hash_change),
